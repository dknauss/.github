...
This repository contains organization/community defaults and shared agent skills. Portions of the documentation, planning notes, examples, tests, comments, or skill instructions may be drafted, revised, summarized, or reorganized with assistance from AI tools such as ChatGPT, Codex, Claude, Copilot, or Cursor.
